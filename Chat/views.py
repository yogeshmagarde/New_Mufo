...
from Chat.consumer import ChatConsumer1,ChatConsumer
from Chat.consumer import ChatConsumer1
...
class RoomViewSets(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        print("joined_room_profile_pictures",joined_room_profile_pictures)
